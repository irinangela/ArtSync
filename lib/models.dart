...
class UserData extends ChangeNotifier {
  ...
  Future<void> updateUsernameInFirestore(UserData userData, String? newUsername) async {
  try {
    ...
    var querySnapshot = await FirebaseFirestore.instance
      .collection('Users')
      .where('username', isEqualTo: user.username) // Change to 'newUsername' if needed
      .get();
...
Future<void> updateChallengeDurationInFirestore(UserData userData, int duration) async {
  ...
  Future<void> updateAvatarInFirestore(UserData userData, String avatarPath) async {
    var user = userData.currentUser?.username;
